const MedicalBackground = () => {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      <div className="absolute left-[10%] top-[15%] opacity-[0.06] animate-float-slow">
      ...
      <div className="absolute right-[15%] top-[20%] opacity-[0.05] animate-float-medium">
      ...
      {/* Jeringa - Middle-left */}
      <div className="absolute left-[8%] top-[50%] opacity-[0.07] animate-float-slower">
      ...
      <div className="absolute right-[12%] top-[55%] opacity-[0.06] animate-float-slow hidden md:block">
      ...
      {/* Diente - Bottom-left */}
      <div className="absolute left-[12%] bottom-[20%] opacity-[0.05] animate-float-medium">
        <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="absolute right-[18%] bottom-[22%] opacity-[0.04] animate-float-slower">
      ...
      <div className="hidden lg:block absolute left-[75%] top-[35%] opacity-[0.06] animate-float-medium">
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M13.5 3C13.5 2.17157 12.8284 1.5 12 1.5C11.1716 1.5 10.5 2.17157 10.5 3V10.5H3C2.17157 10.5 1.5 11.1716 1.5 12C1.5 12.8284 2.17157 13.5 3 13.5H10.5V21C10.5 21.8284 11.1716 22.5 12 22.5C12.8284 22.5 13.5 21.8284 13.5 21V13.5H21C21.8284 13.5 22.5 12.8284 22.5 12C22.5 11.1716 21.8284 10.5 21 10.5H13.5V3Z" fill="currentColor" className="text-primary"/>
        </svg>
      </div>

      <div className="hidden lg:block absolute left-[25%] top-[70%] opacity-[0.05] animate-float-slower">
